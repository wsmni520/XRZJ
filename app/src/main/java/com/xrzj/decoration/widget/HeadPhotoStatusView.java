 ...
 * 仿微博头像动态状态View
 */
public class HeadPhotoStatusView extends AppCompatImageView {
    private static String TAG = "HeadPhotoStatusView";
    private static boolean DEBUG = false;
    private static final float ARC_WIDTH = 12;
    private static final int MIN_WIDTH = 300;
    private static final float CIRCLE_DIA = 0.98f;
    ...
    public HeadPhotoStatusView(Context context) {
        super(context);
        init(context, null);
    }

    public HeadPhotoStatusView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HeadPhotoStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public HeadPhotoStatusView setCircleDuration(int circleDuration) {
        this.mCircleDuration = circleDuration;
        mCircleAnim.setDuration(mCircleDuration);
        return this;
    }

    public HeadPhotoStatusView setRotateDuration(int rotateDuration) {
