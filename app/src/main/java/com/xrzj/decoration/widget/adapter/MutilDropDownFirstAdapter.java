...
public class MutilDropDownFirstAdapter extends BaseRecyclerViewAdapter<MutilDropDownFirstAdapter.ViewHolder> {


    private List<String> mProvinces;
    private Context mContext;

    public MutilDropDownFirstAdapter(Context context, List<String> provinces) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.mAreaTv.setTextColor(mContext.getResources().getColor(R.color.green_text_color));
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView, final MutilDropDownFirstAdapter adapter) {
            super(itemView);
