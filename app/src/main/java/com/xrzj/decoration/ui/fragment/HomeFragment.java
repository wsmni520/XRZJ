package com.xrzj.decoration.ui.fragment;
...
public class HomeFragment extends BaseFragment implements IHomeView{
    ...
    public void initView() {
        ...
        mHomePresenter.setActivity(mActivity);
        initRecyclerView();
    }

    private void initRecyclerView() {
        Log.d("HomeFragment", "initRecyclerView");
        DelegateAdapter delegateAdapter = mHomePresenter.initRecyclerView(mHomeRecycler);
        //把轮播器添加到集合
        BaseDelegateAdapter bannerAdapter = mHomePresenter.initBannerAdapter();
        mAdapters.add(bannerAdapter);
        //初始化九宫格
        BaseDelegateAdapter menuAdapter = mHomePresenter.initGvMenu();
        mAdapters.add(menuAdapter);
        //初始化标题
        BaseDelegateAdapter titleAdapter = mHomePresenter.initTitle("热卖品牌");
        mAdapters.add(titleAdapter);
        //初始化热门品牌栏
        BaseDelegateAdapter popularBrandAdapter = mHomePresenter.initPopularBrand();
